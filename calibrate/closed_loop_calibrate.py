...
starts =  [[hc.window.set_far,             far],
        ...
        #    [hc.window.add_keyhold_action,  key.UP, hc.window.inc_pitch,   delta_angle],
        #    [hc.window.add_keyhold_action,  key.DOWN, hc.window.inc_pitch, -delta_angle],
...
middles = [[cross_hair_image.set_pos, hc.window.get_pos],
           [pts.set_rot, hc.window.get_rot]]
