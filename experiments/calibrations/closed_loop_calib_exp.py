...
delta_pos = 0.1
# delta_pos = 0
# delta_pos = np.zeros((300, 3))
# delta_pos[:100, 0] = 0.2 # this is the one! dim1 is along the body axis
# delta_pos[100:200, 1] = 0.2 # dim2 is along the vertical axis
# delta_pos[200:, 2] = 0.2 # dim3 is along the horizontal axis
...
starts =  [[hc.window.set_far,             far],
        ...
        #    [tracker.virtual_objects['pts'].set_motion_parameters, -.5, 1],
        #    [tracker.virtual_objects['pts'].set_motion_parameters, -1, 0],
